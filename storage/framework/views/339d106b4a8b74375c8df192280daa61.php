        ...
        <div class="carousel-item active">
            <div class="hero-slide" style="background-image: url('/img/bpdeadline.jpg')">
                ...
                <div class="hero-text container">
                    ...
                    <a href="<?php echo e(route('tickets')); ?>" class="btn btn-primary px-4 py-2 mt-2">Get Tickets</a>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item">
            <div class="hero-slide" style="background-image: url('/img/hindia.jpg')">
                ...
                <div class="hero-text container">
                    ...
                    <a href="<?php echo e(route('tickets')); ?>" class="btn btn-primary px-4 py-2 mt-2">Discover</a>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item">
            <div class="hero-slide" style="background-image: url('/img/taylor.jpg')">
                ...
                <div class="hero-text container">
                    ...
                    <a href="<?php echo e(route('tickets')); ?>" class="btn btn-primary px-4 py-2 mt-2">Book Now</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\praktikumakhir\resources\views/home.blade.php ENDPATH**/ ?>